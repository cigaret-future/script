...
label camilleshokerdate:
    ...
    "Camille is fucking me so hard now"
    scene camillescene2pose2fast1 with dissolve
    window hide
    pause
    scene camillescene2pose2fast2 with dissolve
    ...
    "As Camille slow downs, she looks me in the eyes"
    
    cam "I am not done with you yet"
    scene camillescene2pose31 with dissolve
    "Camille flips me onto my side and positions herself behind me"
    scene camillescene2pose32 with dissolve
    cam "Ready for another round?"
    scene camillescene2pose33 with dissolve
    window hide
    pause
    scene camillescene2pose32 with dissolve
    "This new angle hits perfectly"
    "Making me moan like a bitch"
    "I can't help but arch my back for more"
    window hide
    pause
    ...
    scene camillescene2pose32 with dissolve
    name "Oh god... Camille..."
    "My voice comes out as a needy whine, begging for more"
    "She finds her rhythm, steady and energetic, claiming my body as her own"
    scene camillescene2pose33 with dissolve
    window hide
    pause
    scene camillescene2pose32 with dissolve
    ...
    pause
    scene camillescene2pose33 with dissolve
    cam "That's it, let me hear you"
    "I can't help but make desperate little sounds with each thrust"
    "Each thrust hits perfectly, turning me into a trembling mess beneath her"
    ...
    "The intensity builds steadily, reducing me to nothing but pure need"
    "Her praise makes me strangely grateful, as if this is all I'm meant for"
    cam "You're taking me so well"
    ...
    scene camillescene2pose3angle2 with dissolve
    name "Don't stop..."
    "My plea comes out weak and breathless"
    scene camillescene2pose3angle22 with dissolve
    "The sound of her hips hitting my ass echoes through the room"
    "My body betrays how much I crave this, arching into her movements"
    scene camillescene2pose3angle23 with dissolve
    window hide
    pause
    scene camillescene2pose3angle2 with dissolve
    ...
    pause
    scene camillescene2pose3angle22 with dissolve
    "My body moves with her rhythm, completely under her control"
    cam "Yes, that's my good pet"
    "The way she calls me 'pet' makes me feel oddly proud"
    scene camillescene2pose3angle23 with dissolve
    window hide
    pause
    ...
    pause
    scene camillescene2pose3angle22 with dissolve
    "She starts to pick up the pace, and the overwhelming sensations flood my mind"
    "The pleasure intensifies, leaving me a whimpering, desperate mess"
    name "Faster..."
    "I beg shamelessly, completely addicted to what she's doing to me"
    scene camillescene2pose3angle23 with dissolve
    window hide
    pause
    scene camillescene2pose3angle2 with dissolve
    ...
    scene camillescene2pose3angle22 with dissolve
    cam "You want more?"
    "I nod frantically, too far gone to feel embarrassed about my need"
    scene camillescene2pose3angle23 with dissolve
    "She obliges, thrusting with more urgency, turning me into her personal plaything"
    scene camillescene2pose3angle2 with dissolve
    window hide
    pause
    scene camillescene2pose3angle22 with dissolve
    ...
    pause
    scene camillescene2pose3angle23 with dissolve
    "I'm completely lost in the sensation, reduced to nothing but a vessel for her pleasure"
    scene camillescene2pose3angle2 with dissolve
    window hide
    pause
    scene camillescene2pose3angle22 with dissolve
    cam "I am going to fill you up baby"
    cam "You're going to take all of it"
    ...
    "Camille straightens up, taking me forcefully"
    cam "You like that, don't you?"
    cam "You love being fucked like that"
    ...
    cam "You won't be able to walk straight after this"
    ...
    cam "Fuck, I was right about you."
    cam "You take dick like a real slut"
    ...
    window hide
    pause
    "Camille starts to grow impatient"
    "I can feel that she's close to cum inside me"
    "She grabs me by the neck, making me gasp for air"
    scene camillescene2domposeangle50 with dissolve
    cam "Oh fuck..."
    cam "This is too good"
    ...
    pause
    scene camillescene2domposeangle53 with dissolve
    cam "I'm going to put a litter in you."  
    cam "Just like the  you are."  
    ...
    "I can feel her throbbing inside me"
    window hide
    pause
    ...
    cam "Take it!"
    "My all body tenses as Camille cums inside me"
    "I feel her warmth filling me"
    "My ass feels completly submerge by her cum."
    ...
    pause
    scene camillescene2domposeanlge35 with dissolve
    "Camille finally catches her breath."
    ...
    "I swallow her down, lapping up every trace." 
    scene endblowjob2 with dissolve
    window hide
    pause
    scene endblowjob3 with dissolve
    cam "You have been a good pet."
    cam "I am proud of you."
    scene endblowjob2 with dissolve
    window hide
    pause
    scene endblowjob3 with dissolve
    cam "Clean me up properly"
    window hide
    pause
    scene endblowjob2b with dissolve
    "I carefully lick every drop, making sure she's completely clean"
    window hide
    pause
    scene endblowjob1b with dissolve
    cam "That's it, don't waste anything"
    window hide
    pause
    scene endblowjob2b with dissolve
    "The taste lingers on my tongue as I finish my task"
    window hide
    pause
    scene endblowjob1b with dissolve
    cam "Perfect. You're learning so well"
    window hide
    pause
    ...
    cam "Now take the sheet off and clean them."
    cam "I think we're going to have a lot of fun together"
    name "I... ok.."
    scene black with dissolve
    "I gather the sheets in my arms, still feeling weak from what just happened."
    "My legs are shaky as I make my way to the laundry area."
    "The fabric feels damp against my skin, a reminder of our intense encounter."
    "As I start the washing machine, I can still feel Camille's presence in the room."
    "I wonder what I've gotten myself into, but I can't deny how much I enjoyed it."
    "When I return to the bedroom, Camille is already getting dressed."
    cam "Good. You're learning your place quickly."
    cam "I'll text you when I need you again."
