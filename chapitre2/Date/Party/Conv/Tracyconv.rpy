label tracydate:
    if isabelle_balconyparty_done == True:
...
label tracydate2:
    ...
    if stacy_peak_count == 0:
        jump tracypeak1
    elif stacy_peak_count == 1:
        jump tracypeak2
    elif stacy_peak_count == 2:
        jump tracypeak3
    ...
    label tracypeak1:
        ...
        pause
        scene designerview085
        "I think Tracy is looking at me."
