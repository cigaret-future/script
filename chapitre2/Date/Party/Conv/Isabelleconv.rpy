label isabelleconv:
    ...
    label isabelleconvbourre1:
        ...
        name "No, we just met."
        tra "Ah, okay!"
        tra "D'habitude j'arrive pas trop à rencontrer de nouvelles personnes mais vous avez l'air sympa."
        name "Ouai pareil, après l'alcool ça aide aussi"
        tra ""
            # isa "No, I mean really follow your instincts."
            # isa "You know, like when you feel like doing something, and you just do it without thinking."
            # name "Oh, you mean like when you feel like eating a whole pizza and you just do it?"
            # isa "Or, say something to someone without thinking."
            # isa "For example, right now I want to tell you that I have a fantasy I'd like to try."
            # name "Oh, really? What is it?"
            # isa "It's a bit unusual."
        isa "You know, I have a dick."
        name "Yeah, I kind of guessed."
        if gender == "male":
        ...
        "Isabelle looks at me with a mischievous smile."
