label isabelledate:
    ...
    elif isabelledanse_done == True:
        scene firsteric3
        
        isa "Fuck you made me crazy back there."
    ...
    "But Isabelle seems to know exactly what she wants."
    window hide
    pause
    scene contreplongeeric3 with dissolve
    ...
    scene turnarounderic2 with dissolve
    "I can hear her breathing change."
  
    scene turnarounderic3 with dissolve
    if gender == "fem":
        isa "That's a good girl"
    else:
        isa "That's a good boy"
   
    scene turnarounderic2 with dissolve
    "I try to find a rhythm."
    ...
    scene turnarounderic3 with dissolve
    "Her encouragement helps me continue."
    
    scene turnarounderic2 with dissolve
    "I can taste more of her precum now."
    ...
    window hide
    pause
    scene sidebiseric2 with dissolve
    "I can see her face now."
    
    scene sidebiseric3 with dissolve
    ...
    window hide
    pause
    scene sideangleeric1 with dissolve
    "As she pushes deeper into my throat."
    "I gag slightly."
    scene sideangleeric3 with dissolve
    isa "Oops."
    isa "That's was sexy.."
    ...
    scene plongesideeric2 with dissolve
    "I can taste more precum."
    "The wet sounds start filling the small bathroom."
    scene plongesideeric1 with dissolve
    ...
    scene plongesideeric3 with dissolve
    "Her words sends a strange thrill through me."
    ...
    scene plongesideeric2 with dissolve
    "The power dynamic is intoxicating."
    window hide
    pause
    scene plongesideeric3 with dissolve
    ...
    "I can feel her getting more urgent."
   
    scene closesideeric1 with dissolve
    "Her movements are less controlled."
    ...
    # //:::::://////////////////////////////////// closesideeric1 
    scene closeisafinal with dissolve
    window hide
    pause
    ...
    scene closeupsideeric2 with dissolve
    ...
    isa "Oh fuck, I'm getting close..."
    scene fastgoingeric2bis with dissolve
    "Her movements become more urgent and desperate."
    scene fastgoingeric1bis with dissolve
    "I can feel her throbbing in my mouth."
    scene fastgoingeric2 with dissolve
    window hide
    pause
    scene fastgoingeric3 with dissolve
    ...
    pause
    scene fastgoingeric2 with dissolve
    "The taste of her precum fills my mouth completely."
    scene fastgoingeric3 with dissolve
    window hide
    pause
    scene fastgoingeric2bis with dissolve
    isa "Almost there... almost..."
    "I can hear her breathing getting heavier."
    scene fastgoingeric1bis with dissolve
    window hide
    pause
    scene fastgoingeric2 with dissolve
    ...
    window hide
    pause
    scene finalbloweric3 with dissolve
    window hide
    pause
    scene finalbloweric2 with dissolve
    window hide
    ...
    isa "Clean yourself up."  
    isa "Let's keep up appearances."
